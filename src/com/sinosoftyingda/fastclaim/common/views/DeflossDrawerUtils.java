 ...
 * 
 */
public class DeflossDrawerUtils {
	...
	public DeflossDrawerUtils(View gView) {
		this.gView = gView;
		init();
	}
	...
	private void findView() {
		// 抽屉
		sd = (SlidingDrawer) gView.findViewById(R.id.defloss_sliding);
		btnAccept = (Button) gView.findViewById(R.id.defloss_activity_main_bottom_btn_accept);
//		btnAccept.setBackgroundDrawable(gView.getResources().getDrawable(R.drawable.btn_gray_style));
		btnGaiPai = (Button) gView.findViewById(R.id.defloss_activity_main_bottom_btn_gaipai);
//		btnGaiPai.setBackgroundDrawable(gView.getResources().getDrawable(R.drawable.btn_gray_style));
		imageViewIcon = (ImageView) gView.findViewById(R.id.defloss_imageViewIcon);
		rllayout = (RelativeLayout) gView.findViewById(R.id.defloss_allApps);
	}
