...
public class HandleingAdapter extends BaseAdapter {
	...
	public HandleingAdapter(Context context, List<CertainLossTask> certainLossTasks) {
		this.certainLossTasks = certainLossTasks;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				SystemConfig.isOperate = true;// 如果同步理赔，应为false，如果继续操作，应为true
		...
		if ("".equals(certainLossTask.getContacttime())) {
		...
		holder.banAnPhone.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (phoneStateReceiver != null) {
					phoneStateReceiver.setRegistno(certainLossTask.getRegistno());
					phoneStateReceiver.setItemno(certainLossTask.getItemno());
				}
				*/
			}
		});
