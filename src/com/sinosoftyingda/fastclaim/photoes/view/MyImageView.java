...
public class MyImageView extends ImageView {
	...
	protected void onDraw(Canvas canvas) {
		...
		if (width > ShowPhotoActivity.screenWidth) {
		// 如果图宽大于屏宽，就不用水平居中
		center(false, true);
		} else {
		center(true, true);
	...
	private void arithScaleRate() {
		float scaleWidth = ShowPhotoActivity.screenWidth / (float) imageWidth;
		float scaleHeight = ShowPhotoActivity.screenHeight / (float) imageHeight;
	...
	public void setImageBitmap(Bitmap bitmap) {
		...
		arithScaleRate();
		//缩放到屏幕大小
		zoomTo(scaleRate,ShowPhotoActivity.screenWidth / 2f, ShowPhotoActivity.screenHeight / 2f);
	...
	public void layoutToCenter()
	{
		...
		//空白区域宽高
		float fill_width = ShowPhotoActivity.screenWidth - width;
		float fill_height = ShowPhotoActivity.screenHeight - height;
	...
	protected float getValue(Matrix matrix, int whichValue) {
		...
		mMinZoom =( ShowPhotoActivity.screenWidth/2f)/imageWidth;
